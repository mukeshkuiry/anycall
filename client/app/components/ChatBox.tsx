...
const ChatBox = (props: Props) => {
  ...
  return (
    <div className="flex flex-col w-2/3 min-h-[calc(100vh-4rem)] max-h-screen  backdrop-blur-sm bg-[#ffffff10] m-8">
            ...
            {index === 0 ? (
              ...
              >
                <div
                  className={` ${
                    randomId === msg.senderId
                      ? "bg-blue-500 rounded-l-lg rounded-t-lg"
                      : "bg-green-500 rounded-r-lg rounded-t-lg"
                  } text-white  px-4 p-2 max-w-xs text-lg`}
                >
                  {msg.content}
                </div>
